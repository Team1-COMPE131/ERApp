...
- (void)viewDidLoad
{
    ...
    expenseType = [[NSMutableString alloc] initWithString:@"Airfare"];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section==0) {
        ...
        if (indexPath.row==0) {
            ...
            UIImageView *imView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 320, 132)];
...
-(void)addReport:(id)sender {
    ...
    ASIFormDataRequest *dr = [[ASIFormDataRequest alloc] initWithURL:[NSURL URLWithString:@"http://server2.kevjung.com/~erapp/receipt_proc.php"]];
    [dr setData:UIImageJPEGRepresentation(selImage, 0.4f) withFileName:@"file.jpeg" andContentType:@"image/jpeg" forKey:@"image"];
    [dr startSynchronous];
